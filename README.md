🎨 Anima WebUI <small>v1.4.1</small>

Anima WebUI は、ComfyUI をバックエンドとして利用し、直感的な操作で高品質な画像生成を行うための Gradio ベースの Web UI です。 v1.4.1 では、プロンプト入力欄に**「強調ボタン」**を追加し、重み付けの調整がより直感的になりました。
🎯 想定するユーザ層
